  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 space-y-8">
        {/* API Key Warning for missing key */}
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-yellow-700 mt-1">
                  You need to configure your OpenAI API key to generate startup ideas. Click the settings button above to add your key.
                </p>
              </div>
            </div>
          </div>
      ...
      {/* API Key Modal - only show if no environment key */}
      {showApiKeyModal && !import.meta.env.VITE_OPENAI_API_KEY && (
